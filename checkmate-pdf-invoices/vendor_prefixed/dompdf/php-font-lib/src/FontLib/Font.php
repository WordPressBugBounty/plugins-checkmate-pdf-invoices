...
namespace Checkmate\Vendor\FontLib;
...
class Font {
  ...
  public static function load($file) {
    ...
    if ($class) {
      // This library is bundled with a vendor prefix (Strauss).
      // Avoid hard-coded unprefixed namespace strings that bypass the autoloader.
