 ...
 */
namespace Checkmate\Vendor\FontLib\Glyph;

use Checkmate\Vendor\FontLib\Table\Type\glyf;
use Checkmate\Vendor\FontLib\TrueType\File;
...
class Outline extends BinaryStream {
  /**
   * @var \Checkmate\Vendor\FontLib\Table\Type\glyf
   */
  protected $table;
