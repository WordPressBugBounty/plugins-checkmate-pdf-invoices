...
namespace Checkmate\Vendor\FontLib\Table\Type;

use Checkmate\Vendor\FontLib\Table\Table;
use Checkmate\Vendor\FontLib\Glyph\Outline;
use Checkmate\Vendor\FontLib\Glyph\OutlineSimple;
