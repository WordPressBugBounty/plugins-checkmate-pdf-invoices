...
namespace Checkmate\Vendor\Svg\Surface;

use Checkmate\Vendor\Svg\Document;
...
class SurfaceCpdf implements SurfaceInterface
{
    ...
    /** @var \Checkmate\Vendor\Svg\Surface\CPdf */
    private $canvas;
    ...
    public function __construct(Document $doc, $canvas = null)
    {
        ...
        if (!$canvas) {
            $canvas = new \Checkmate\Vendor\Svg\Surface\CPdf(array(0, 0, $w, $h));
