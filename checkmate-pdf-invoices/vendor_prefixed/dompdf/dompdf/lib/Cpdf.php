...
use Checkmate\Vendor\FontLib\Font;
use Checkmate\Vendor\FontLib\BinaryStream;
...
EOT;
    ...
    {
        $doc = new \Checkmate\Vendor\Svg\Document();
        $doc->loadFile($file);
        ...
        $surface = new \Checkmate\Vendor\Svg\Surface\SurfaceCpdf($doc, $this);
        $doc->render($surface);
