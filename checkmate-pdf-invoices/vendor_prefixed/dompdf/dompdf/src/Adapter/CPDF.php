...
namespace Checkmate\Vendor\Dompdf\Adapter;

use Checkmate\Vendor\Dompdf\Canvas;
use Checkmate\Vendor\Dompdf\Dompdf;
use Checkmate\Vendor\Dompdf\Exception;
use Checkmate\Vendor\Dompdf\FontMetrics;
use Checkmate\Vendor\Dompdf\Helpers;
use Checkmate\Vendor\Dompdf\Image\Cache;
use Checkmate\Vendor\FontLib\Exception\FontNotFoundException;
...
class CPDF implements Canvas
{
     ...
     *
     * @var \Checkmate\Vendor\Dompdf\Cpdf
     */
    protected $_pdf;
    ...
    public function __construct($paper = "letter", string $orientation = "portrait", ?Dompdf $dompdf = null)
    {
        ...
        $this->_pdf = new \Checkmate\Vendor\Dompdf\Cpdf(
            $size,
            true,
     ...
     *
     * @return \Checkmate\Vendor\Dompdf\Cpdf
     */
    ...
    public function select($x, $y, $w, $h, $font, $size, $color = [0, 0, 0], $opts = [])
    {
        ...
        $ft = \Checkmate\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE;
        $ff = \Checkmate\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE_COMBO;
    ...
    public function textarea($x, $y, $w, $h, $font, $size, $color = [0, 0, 0])
    {
        ...
        $ft = \Checkmate\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
        $ff = \Checkmate\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_MULTILINE;
    ...
    public function input($x, $y, $w, $h, $type, $font, $size, $color = [0, 0, 0])
    {
        ...
        switch ($type) {
            ...
            case 'password':
                $ft = \Checkmate\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
                $ff = \Checkmate\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_PASSWORD;
                break;
            case 'submit':
                $ft = \Checkmate\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_BUTTON;
                break;
        }
