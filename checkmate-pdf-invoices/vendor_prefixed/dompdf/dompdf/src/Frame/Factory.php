 ...
 */
namespace Checkmate\Vendor\Dompdf\Frame;
...
use Checkmate\Vendor\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use Checkmate\Vendor\Dompdf\FrameReflower\Page as PageFrameReflower;
use Checkmate\Vendor\Dompdf\Positioner\AbstractPositioner;
use DOMXPath;
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null): ?AbstractFrameDecorator
    {
        ...
        $decorator  = "Checkmate\\Vendor\\Dompdf\\FrameDecorator\\$decorator";
        $reflower   = "Checkmate\\Vendor\\Dompdf\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance(string $type): AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\Checkmate\\Vendor\\Dompdf\\Positioner\\'.$type;
